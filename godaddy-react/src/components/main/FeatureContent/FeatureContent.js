...
import WordpressHostingImage from "../../../assets/images/MCXMO-63401-IN-HP-MWP-blade.jpg";
import ProImage from "../../../assets/images/img-feat-pro.jpg";
import ResellerImage from "../../../assets/images/img-feat-reseller.jpg";
        ...
        <div className='feature-content'>
            ...
            <div className='content-wrapper'>
              ...
              <div className='content'>
                <p>
                  ...
                  perform. From automated updates and backups to
                  industry-leading load times, this is WordPress how it was
                  meant to be.
                </p>
              </div>
          ...
          <div className='item'>
            ...
            <div className='content-wrapper'>
              ...
              <h3 className='sub-title'>
                Start your business with our products.
              </h3>
              <div className='content'>
                <p>
                  Our Reseller Program lets you open your own online business in
                  a matter of hours. You choose which GoDaddy products you want
                  to sell — and for how much — and we provide the rest, from the
                  web store to payment processing.
                </p>
              </div>
              <div className='content-btn'>
                <button className='btn btn-light btn-content'>
